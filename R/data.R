...
#' with information of name, population in 2010 and 2019, and land area.
#'
...
#' @source \url{http://worldpopulationreview.com/states/california-population/cities/}
"ca"



#' Information about Best-Rated Restaurants in Counties of California and More
#'
